  ...
  if(isset($_POST['employer']) && isset($_POST['address'])
    ...
    if ($_POST['current'] == 'No') {
      if ($_POST['end_date'] == '') {
        ...
        header("Location: addemployment.php?borrower_id=$bi");
        return;
      };
    };
    ...
    $sql = "INSERT INTO employment (employer, address, income_source,
      occupation, start_date, current_source, end_date, income, bonus, type,
      frequency, borrower_id) VALUES (:employer, :address, :income_source,
      :occupation, :start_date, :current_source, :end_date, :income, :bonus,
