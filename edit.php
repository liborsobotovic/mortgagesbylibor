...
<body>
  ...
  if (! in_array($_GET['borrower_id'], $rows)) {
    $_SESSION['error'] = "Unauthorized acces";
    header('Location: index.php');
    return;
  };

  if (isset($_POST['first_name']) && isset($_POST['last_name'])
    && isset($_POST['borrower_id'])) {
      if (empty($_POST['first_name']) || empty($_POST['last_name'])) {
        $_SESSION['error'] = "All the fields are required";
        $_SESSION['borrower_id'] = $_POST['borrower_id'];
        header('Location: edit.php');
        return;
      }
    $sql = "UPDATE borrower SET first_name = :first_name,
      last_name = :last_name WHERE borrower_id = :borrower_id";
    $stmt = $pdo->prepare($sql);
    $stmt->execute(array(
    ...
    $_SESSION['success'] = htmlentities($_POST['first_name'])
  ...
  if ($row == false) {
    $_SESSION['error'] = "This borrower does not exist";
    header('Location: application.php');
    return;
  }
  ...
  <div class="centered-edit">
    <form method="post">
      <p>
        ...
        <input type="text" id="first_name" name="first_name" value="<?= $fn ?>">
      </p>
      <p>
        <label for="last_name">Last Name</label>
        <input type="text" id="last_name" name="last_name" value="<?= $ln ?>">
